        ...
        if (event == "telemetry") {
          // j[1] is the data JSON object
			...
			for(int i = 0; i < sensor_fusion.size(); i++)
			{
				...
				#ifdef PRINT_VARS
				std::cout<<"id"<< sensor_fusion[i][0]<<"d:"<< d << endl;
				#endif
			...
			#ifdef PRINT_VARS
			std::cout << "previous_path_x" << previous_path_x.size() <<endl;
			#endif
          	...
          	/* //=>FIRST_SOLUTION
						...
						*/
						 ...
						 //either we will reference the starting point as where the car is ot at the previous paths end points
						 double ref_x = car_x;
						 double ref_y = car_y;
